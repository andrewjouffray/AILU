...
def using_color(image):
    ...
    threshold2 = cv2.morphologyEx(threshold1, cv2.MORPH_OPEN, rect_kernel)
    ...
    contours, hierarchy = cv2.findContours(threshold3,cv2.RETR_TREE,cv2.CHAIN_APPROX_NONE)
